        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 20 }}>
          <div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>
            {navLinks.map((link, i) => (
              <span key={link.path} style={{ display: 'flex', alignItems: 'center' }}>
                <Link to={link.path} style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 400, fontSize: 15, color: '#000' }}>
                  {link.label}
                </Link>
                {i < navLinks.length - 1 && (
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 32, flexWrap: 'wrap' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <a href="mailto:artisticroofing11@gmail.com" style={{ fontFamily: 'Outfit', fontWeight: 400, fontSize: 15, color: 'var(--color-2)' }}>
