  ...
  return (
    <>
      ...
      <section style={{
        position: 'relative',
        width: '100%',
        minHeight: 'max(500px, 66.6vw)',
        backgroundImage: 'linear-gradient(180deg, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0.35) 50%, rgba(0,0,0,0.20) 100%), url(/img/testimonials/Testimonials%20Hero.png)',
