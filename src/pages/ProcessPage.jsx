...
export default function ProcessPage() {
  return (
    <>
      {/* Hero */}
      <section style={{ position: 'relative', minHeight: 400, backgroundImage: 'url(/img/frame-2147223464.png)', backgroundSize: 'cover', backgroundPosition: '50% 30%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', paddingTop: 80 }}>
